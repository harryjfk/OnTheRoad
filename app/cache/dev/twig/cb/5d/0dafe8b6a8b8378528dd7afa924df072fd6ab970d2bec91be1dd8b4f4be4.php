...
/* OnTheRoadOnTheRoadBundle:TComment:indexfront.html.twig */
class __TwigTemplate_cb5d0dafe8b6a8b8378528dd7afa924df072fd6ab970d2bec91be1dd8b4f4be4 extends Twig_Template
{
    ...
    public function block_container($context, array $blocks = array())
    {
        ...
        echo $this->env->getExtension('translator')->getTranslator()->trans("New Comment", array(), "messages");
        echo "</a>
         </div>
     </div>
         ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["comentario"]) {
            ...
            echo "\">
                         <a class=\"updt\"
                            href=\"";
            // line 19
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("viewcomment", array("id" => $this->getAttribute((isset($context["comentario"]) ? $context["comentario"] : $this->getContext($context, "comentario")), "id"), "locale" => (isset($context["customlocale"]) ? $context["customlocale"] : $this->getContext($context, "customlocale")))), "html", null, true);
            echo "\">
                             ";
            // line 20
 ...
 ";
    ...
    {
        return "OnTheRoadOnTheRoadBundle:TComment:indexfront.html.twig";
    }
    ...
    {
        return array (  94 => 35,  82 => 29,  72 => 22,  67 => 20,  63 => 19,  58 => 17,  53 => 14,  49 => 13,  45 => 11,  37 => 7,  33 => 5,  31 => 4,  28 => 3,);
    }
}
